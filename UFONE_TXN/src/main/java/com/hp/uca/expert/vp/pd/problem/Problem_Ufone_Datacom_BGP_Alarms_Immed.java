...
public class Problem_Ufone_Datacom_BGP_Alarms_Immed extends PTCL_Base_Problem {
	...
	public static void calculate_frn(Group group, int index, String frn, String add_text_list,String parsing_logic,String alc){
...
//        LOG.debug(String.format(" JAVA_LOG_RULE[%s]",log));
	...
	public void calculateProblemAlarmOtherAttribute(Group group, Action action) throws Exception {
		...
		for(Alarm alarm : group.getAlarmList()) {
			...
			calculate_frn(group, alarm_list_index,frn,add_text_list_short,pl,alc); //Processing friendly name
