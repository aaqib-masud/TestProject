package com.hp.uca.expert.vp.pd.WLL_BSC_DataService_Huawei_R;
...
public class UCA_WLL_BSC_DataService_Huawei_R extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_WLL_BSC_DataService_Huawei_R.class);

	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/WLL_BSC_DataService_Huawei_R/";
	private static final String ALARM_1= "Alarm_WLL_BSC_DataService_Huawei_R";
	...
	private static final String groupKEY1 = "<p>Problem_WLL_BSC_DataService_Huawei_R</p><e>nfitrbsc6680</e>";
	...
	public UCA_WLL_BSC_DataService_Huawei_R() {
		super("test1");
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_WLL_BSC_DataService_Huawei_R.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_WLL_BSC_DataService_Huawei_R.class);
	}
