package com.hp.uca.expert.vp.pd.WLL_EW_M3UA_OCG_LINK;
...
public class UCA_WLL_EW_M3UA_OCG_LINK extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_WLL_EW_M3UA_OCG_LINK.class);

	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/WLL_EW_M3UA_OCG_LINK/";
	private static final String ALARM_Trigger= "Alarm_WLL_EW_M3UA_OCG_LINK_Trigger";
	private static final String ALARM_Sub= "Alarm_WLL_EW_M3UA_OCG_LINK_SubAlarm";
	private static final String groupKEY1 = "<p>Problem_WLL_EW_M3UA_OCG_LINK</p><e>mirp4061-barhing</e>";
	...
	public UCA_WLL_EW_M3UA_OCG_LINK() {
		super("test1");
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_WLL_EW_M3UA_OCG_LINK.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_WLL_EW_M3UA_OCG_LINK.class);
	}
