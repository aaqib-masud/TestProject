package com.hp.uca.expert.vp.pd.SECTOR_NOSUB_ACCESS_NR;
...
public class UCA_SECTOR_NOSUB_ACCESS_NR extends AbstractTest {
	
	/**
	 * The log.
	 */
	private static Logger log = LoggerFactory.getLogger(UCA_SECTOR_NOSUB_ACCESS_NR.class);

	protected static final String ALARM_FILE_PREFIX = "src/test/resources/com/hp/uca/expert/vp/pd/SECTOR_NOSUB_ACCESS_NR/";
	private static final String ALARM_Trigger= "Alarm_SECTOR_NOSUB_ACCESS_NR_Trigger";
	private static final String ALARM_Sub= "Alarm_SECTOR_NOSUB_ACCESS_NR_Sub";
	...
	public UCA_SECTOR_NOSUB_ACCESS_NR() {
		super("test1");
	...
	public static void setUpBeforeClass() throws Exception {
		log.info(Constants.TEST_START.val()
				+ UCA_SECTOR_NOSUB_ACCESS_NR.class.getName());
	}
	...
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(UCA_SECTOR_NOSUB_ACCESS_NR.class);
	}
